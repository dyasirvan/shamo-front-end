          ...
          children: [
            ...
            Container(
              ...
              child: TextButton(
                ...
                child: Text('Order Other Shoes', style: primaryTextStyle.copyWith(fontSize: 16),),
              ),
            ),
            Container(
              ...
              child: TextButton(
                ...
                child: Text('View My Order', style: primaryTextStyle.copyWith(fontSize: 16, color: Color(0xffB7B6BF)),),
              ),
            )
          ],
        ),
